...
export class BlogServiceProxy {
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<BlogDto> {
        let url_ = this.baseUrl + "/api/services/app/Blog/Get?";
        if (id === null)
    ...
    protected processGet(response: HttpResponseBase): Observable<BlogDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<BlogDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Blog/GetAll?";
        if (sorting === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<BlogDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<BlogDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<BlogDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = BlogDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<BlogDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(body: BlogDto | undefined): Observable<BlogDto> {
        let url_ = this.baseUrl + "/api/services/app/Blog/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    update(body: BlogDto | undefined): Observable<BlogDto> {
        let url_ = this.baseUrl + "/api/services/app/Blog/Update";
        url_ = url_.replace(/[?&]$/, "");
...
export class BlogDto implements IBlogDto {
    ...
    typeofDocument: string | undefined;
    shortContents: string | undefined;
    mainContents: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.typeofDocument = _data["typeofDocument"];
            this.shortContents = _data["shortContents"];
            this.mainContents = _data["mainContents"];
    ...
    toJSON(data?: any) {
        ...
        data["shortContents"] = this.shortContents;
        data["mainContents"] = this.mainContents;
